...
if draw_char == text_lenght[page] && page == page_number -1
{
	...
	for ( var op = 0; op < option_number; op++)
	{
		...
		draw_sprite_ext(txtb_spr[page], txtb_img, _txtb_x + 16, _txtb_y - _op_space * option_number +_op_space*op, _o_w/txtb_spr_w,(_op_space+10)/txtb_spr_h, 0, c_white, 1);
...
for (var c=0;c < draw_char;c++)
{
	...
	if shake_text[c, page] == true
	{
		...
		if shake_timer[c, page] <=2{
			...
			_shake_y = lengthdir_x(1, shake_dir[c, page]);
		}
	}
	
	draw_text_colour(char_x[c, page] + _shake_x, char_y[c, page] + _float_y + _shake_y, char[c, page], col_1[c, page], col_1[c, page], col_1[c, page], col_1[c, page], 1);
}